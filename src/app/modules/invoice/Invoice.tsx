                        ...
                        <tbody>
                          <tr className='fw-bold text-gray-700 fs-5 text-end'>
                            <td className='d-flex align-items-center pt-11'>
                              <i className='fa fa-genderless text-danger fs-1 me-2'></i>Creative
                              Design
                            </td>
                          ...
                          <tr className='fw-bold text-gray-700 fs-5 text-end'>
                            <td className='d-flex align-items-center'>
                              <i className='fa fa-genderless text-success fs-1 me-2'></i>Logo Design
                            </td>
                            <td>120</td>
                            <td>$40.00</td>
                          ...
                          <tr className='fw-bold text-gray-700 fs-5 text-end'>
                            <td className='d-flex align-items-center pb-10'>
                              <i className='fa fa-genderless text-primary fs-1 me-2'></i>Web
                              Development
                            </td>
                            <td>210</td>
                            <td>$60.00</td>
