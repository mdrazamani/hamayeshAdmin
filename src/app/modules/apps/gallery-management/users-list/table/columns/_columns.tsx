...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='GALERY.TABLE.GALERY' className='min-w-125px' />
    ),
    id: 'category',
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='GALERY.TABLE.SLUG' className='min-w-125px' />
    ),
    id: 'slug',
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='GALERY.TABLE.CREATEDAT' className='min-w-125px' />
    ),
    id: 'createdAt',
